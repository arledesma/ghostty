...
- [x] **PLAT-03**: User receives Windows toast notifications when long-running commands complete
- [x] **PLAT-04**: User can open a searchable command palette with Ctrl+Shift+P
